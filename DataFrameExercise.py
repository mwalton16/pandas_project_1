...
df_2 = exam_df.loc[['a','c','e','f'],['name','score']]
#print(df_2)
...
df_3 = exam_df[exam_df['attempts'] > 2]
#print(df_3)
...
df_4 = exam_df[(exam_df['score'] >= 15) & (exam_df['score'] <= 20)]
print(df_4)
...
df_5 = exam_df.sort_values(by = ['attempts','name'])
print(df_5)
